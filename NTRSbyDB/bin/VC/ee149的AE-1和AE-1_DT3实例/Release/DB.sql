...
SELECT AE_1_DT3_result.inspect_text AS value,
CASE
WHEN(AE_1_result.type IS NULL OR AE_1_DT3_result.type IS NULL)THEN NULL
WHEN(AE_1_result.type='NG' OR AE_1_DT3_result.type='NG')THEN 'NG'
ELSE AE_1_DT3_result.type
END AS type,
AE_1_result.message||'
'||AE_1_DT3_result.message AS message
,*
FROM AE_1_result,AE_1_DT3_result